...
<body>
    ...
    <div class="sidebar-footer">
      ...
      <div class="admin-user tooltip-element" data-tooltip="1">
        <div class="admin-profile hide">
          <img src="assets/bgpics/img/face-1.png" alt="">
  ...
  <main>
    <h1><?php echo "<h1>Welcome Admin: " . $_SESSION['username'] . "</h1>"; ?></h1>
   
    
    <a href="logout.php">Logout</a>
    
    <p class="copyright">
      &copy; 2021 - <span>Doc Zone</span> All Rights Reserved.
    </p>
  </main>
